...
class CustomNewCarAddImageSection extends StatelessWidget {
  const CustomNewCarAddImageSection({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SellNewCarCubit, SellNewCarState>(
      builder: (context, state) {
        final cubit = context.watch<SellNewCarCubit>();
        return Column(
          children: [
            Align(
  ...
  Widget _buildSelectedImageItem(BuildContext context, int index) {
    final cubit = context.read<SellNewCarCubit>();
