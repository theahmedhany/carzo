...
part of 'maintenance_companies_state.dart';
...
/// @nodoc
mixin _$MaintenanceCompaniesState<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $MaintenanceCompaniesStateCopyWith<T, $Res> {
  factory $MaintenanceCompaniesStateCopyWith(
    MaintenanceCompaniesState<T> value,
    $Res Function(MaintenanceCompaniesState<T>) then,
  ) =
      _$MaintenanceCompaniesStateCopyWithImpl<
        T,
        $Res,
        MaintenanceCompaniesState<T>
      >;
}

/// @nodoc
class _$MaintenanceCompaniesStateCopyWithImpl<
  T,
  $Res,
  $Val extends MaintenanceCompaniesState<T>
>
    implements $MaintenanceCompaniesStateCopyWith<T, $Res> {
  _$MaintenanceCompaniesStateCopyWithImpl(this._value, this._then);
  ...
  /// Create a copy of MaintenanceCompaniesState
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$MaintenanceCompaniesStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
class _$IdleImpl<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'MaintenanceCompaniesState<$T>.idle()';
  }
...
abstract class Idle<T> implements MaintenanceCompaniesState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$MaintenanceCompaniesStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'MaintenanceCompaniesState<$T>.loading()';
  }
...
abstract class Loading<T> implements MaintenanceCompaniesState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$MaintenanceCompaniesStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'MaintenanceCompaniesState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements MaintenanceCompaniesState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$MaintenanceCompaniesStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'MaintenanceCompaniesState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements MaintenanceCompaniesState<T> {
